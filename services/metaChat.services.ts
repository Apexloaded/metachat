...
import { metaChatABI, metaChatAddress } from "../constant";
import Web3Modal from "web3modal";

const INFURA_RPC = process.env.INFURA_RPC_URL;
const INFURA_ID = process.env.INFURA_ID;

export const fetchContract = (provider: ethers.providers.JsonRpcSigner) =>
  new ethers.Contract(metaChatAddress, metaChatABI, provider);
